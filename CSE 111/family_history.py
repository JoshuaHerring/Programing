...
def print_death_age(people_dict):
    ...
    for key in people_dict:
        list = people_dict[key]
        age_at_death = list[DEATH_YEAR_INDEX] - list[BIRTH_YEAR_INDEX]
        print(f'Name: {list[NAME_INDEX]}, Age at death: {age_at_death}')
...
def print_marriages(marriages_dict, people_dict):
    ...
    for key in marriages_dict:
        list = marriages_dict[key]
        husband = list[HUSBAND_KEY_INDEX]
        wife = list[WIFE_KEY_INDEX]
