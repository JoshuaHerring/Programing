...
def main():
    ...
    try:
        ...
        print(f'Error: This is not real.')
    except PermissionError as ex:
        print(f'Errpr: You do not have permisison to view this file.')
    finally:
    ...
    with open(filename, "rt") as text_file:
        ...
        try:
            ...
            print(f'Error: Your inoput was not a valid number. ')
        ...
        try:
            ...
            print('There is a problem wiht the format of your csv file.')
